...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function get_true_false_input($field_info,$value)
	{
		...
		$input .= "<label style='width:100px;'><input id='field-{$field_info->name}-true' class='radio-uniform'  type='radio' name='{$field_info->name}' value='1' $checked /> ".$true_string."</label> ";
		...
		$input .= "<label style='width:100px;'><input id='field-{$field_info->name}-false' class='radio-uniform' type='radio' name='{$field_info->name}' value='0' $checked /> ".$false_string."</label>";
	...
	protected function get_add_input_fields($field_values = null)
	{
		...
		foreach($fields as $field_num => $field)
		{
			...
			$field_value = !empty($field_values) && isset($field_values->{$field->field_name}) ? $field_values->{$field->field_name} : null;
                        $field_value = (!isset($field_value) && isset($field_info->default_value)? $field_info->default_value : $field_value);
...
//@todo ui_day, ui_month, ui_year has to be lang strings
	...
	public function set_relation_n_n($field_name, $relation_table, $selection_table, 
                ...
                $title_field_selection_table , $priority_field_relation_table = null, 
